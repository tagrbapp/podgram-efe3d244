...
const AuctionCard = ({
  ...
  return (
    <Card
      className="group relative overflow-hidden cursor-pointer bg-card border border-border/50 hover:border-primary/40 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
        ...
        <div className="absolute top-3 left-3 right-3 flex items-center justify-between z-10">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center gap-1.5 bg-white/95 backdrop-blur-sm rounded-full px-3 py-1.5 shadow-sm">
              ...
              <span className="text-xs font-semibold text-foreground">{totalBids}</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="flex items-center justify-between pt-3 border-t border-border">
          <div className="space-y-0.5">
            ...
            <p className="text-sm font-bold text-primary">
              {startingPrice.toLocaleString("ar-SA")} ر.س
            </p>
          </div>
          ...
          <div className="space-y-0.5 text-left">
            ...
            <p className="text-lg font-bold text-foreground">
              {(currentBid || startingPrice).toLocaleString("ar-SA")} ر.س
            </p>
          </div>
        </div>
